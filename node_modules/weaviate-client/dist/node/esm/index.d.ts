...
declare const app: {
  ...
  configure: {
    generative: {
      ...
      >;
      palm: (
        config: import('./collections/index.js').GenerativePaLMConfig
      ) => import('./collections/index.js').ModuleConfig<
        'generative-palm',
        import('./collections/index.js').GenerativePaLMConfig
      >;
    };
    reranker: {
      cohere: (
    ...
    vectorizer: {
      ...
      ref2VecCentroid: <N_5 extends string | undefined = undefined, I_5 extends string = 'hnsw'>(
        opts: import('./collections/index.js').ConfigureNonTextVectorizerOptions<N_5, I_5, 'ref2vec-centroid'>
      ) => import('./collections/index.js').VectorConfigCreate<never, N_5, I_5, 'ref2vec-centroid'>;
      text2VecAWS: <T, N_6 extends string | undefined = undefined, I_6 extends string = 'hnsw'>(
        opts: import('./collections/index.js').ConfigureTextVectorizerOptions<T, N_6, I_6, 'text2vec-aws'>
        ...
        'text2vec-aws'
      >;
      text2VecAzureOpenAI: <T_1, N_7 extends string | undefined = undefined, I_7 extends string = 'hnsw'>(
        ...
        'text2vec-azure-openai'
      >;
      text2VecCohere: <T_2, N_8 extends string | undefined = undefined, I_8 extends string = 'hnsw'>(
        opts?:
        ...
        'text2vec-cohere'
      >;
      text2VecContextionary: <T_3, N_9 extends string | undefined = undefined, I_9 extends string = 'hnsw'>(
        opts?:
      ...
      >;
      text2VecGPT4All: <T_4, N_10 extends string | undefined = undefined, I_10 extends string = 'hnsw'>(
        opts?:
        ...
        'text2vec-gpt4all'
      >;
      text2VecHuggingFace: <T_5, N_11 extends string | undefined = undefined, I_11 extends string = 'hnsw'>(
        opts?:
          | (import('./collections/index.js').Text2VecHuggingFaceConfig & {
              ...
              vectorIndexConfig?:
                | import('./collections/index.js').ModuleConfig<
                    I_11,
                    import('./collections/index.js').VectorIndexConfigCreateType<I_11>
                  >
                | undefined
              /**
               * The connection parameters for Weaviate's public APIs.
      ...
      >;
      text2VecJina: <T_6, N_12 extends string | undefined = undefined, I_12 extends string = 'hnsw'>(
        opts?:
        ...
        'text2vec-jina'
      >;
      text2VecOpenAI: <T_7, N_13 extends string | undefined = undefined, I_13 extends string = 'hnsw'>(
        opts?:
        ...
        'text2vec-openai'
      >;
      text2VecOllama: <T_8, N_14 extends string | undefined = undefined, I_14 extends string = 'hnsw'>(
        opts?:
        ...
        'text2vec-ollama'
      >;
      text2VecPalm: <T_9, N_15 extends string | undefined = undefined, I_15 extends string = 'hnsw'>(
        opts?:
          | (import('./collections/index.js').Text2VecPalmConfig & {
              name?: N_15 | undefined;
        ...
        'text2vec-palm'
      >;
      text2VecTransformers: <T_10, N_16 extends string | undefined = undefined, I_16 extends string = 'hnsw'>(
        opts?:
      ...
      >;
      text2VecVoyageAI: <T_11, N_17 extends string | undefined = undefined, I_17 extends string = 'hnsw'>(
        opts?:
    ...
    vectorIndex: {
      flat: (
        ...
        'flat',
        | import('./collections/index.js').RecursivePartial<
            import('./collections/index.js').VectorIndexConfigFlat
          >
        | undefined
      >;
      hnsw: (
        ...
        'hnsw',
        | import('./collections/index.js').RecursivePartial<
            import('./collections/index.js').VectorIndexConfigHNSW
          >
        | undefined
      >;
      dynamic: (
        ...
        'dynamic',
        | import('./collections/index.js').RecursivePartial<
            import('./collections/index.js').VectorIndexConfigDynamic
          >
        | undefined
      >;
      quantizer: {
    ...
    invertedIndex: (options: {
      ...
      import('./collections/index.js').InvertedIndexConfig
    >;
    multiTenancy: (
      options?:
        | {
      ...
      import('./collections/index.js').MultiTenancyConfig
    >;
    replication: (options: {
      factor?: number | undefined;
    }) => import('./collections/index.js').RecursivePartial<
      import('./collections/index.js').ReplicationConfig
    >;
    sharding: (options: {
  ...
  reconfigure: {
    ...
    vectorizer: {
      update: <N_18 extends string | undefined, I_18 extends string>(
        options: import('./collections/index.js').VectorizerUpdateOptions<N_18, I_18>
      ) => import('./collections/index.js').VectorConfigUpdate<N_18, I_18>;
    };
    replication: (options: {
      factor?: number | undefined;
    }) => import('./collections/index.js').RecursivePartial<
