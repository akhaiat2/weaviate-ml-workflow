...
export const SearchRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      sortBy: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.sortBy)
        ? object.sortBy.map((e) => SortBy.fromJSON(e))
        : [],
  ...
  fromPartial(object) {
    ...
    message.sortBy =
      ((_h = object.sortBy) === null || _h === void 0 ? void 0 : _h.map((e) => SortBy.fromPartial(e))) || [];
    message.filters =
    ...
    message.generative =
      object.generative !== undefined && object.generative !== null
        ...
        : undefined;
    message.rerank =
      object.rerank !== undefined && object.rerank !== null ? Rerank.fromPartial(object.rerank) : undefined;
  ...
  fromPartial(object) {
    ...
    message.refProperties =
      ((_b = object.refProperties) === null || _b === void 0
        ? void 0
        : _b.map((e) => RefPropertiesRequest.fromPartial(e))) || [];
    message.objectProperties =
      ((_c = object.objectProperties) === null || _c === void 0
        ? void 0
        : _c.map((e) => ObjectPropertiesRequest.fromPartial(e))) || [];
  ...
  fromPartial(object) {
    ...
    message.results =
      ((_b = object.results) === null || _b === void 0
        ? void 0
        : _b.map((e) => SearchResult.fromPartial(e))) || [];
    ...
    message.groupByResults =
      ((_d = object.groupByResults) === null || _d === void 0
        ? void 0
        : _d.map((e) => GroupByResult.fromPartial(e))) || [];
    return message;
  },
};
  ...
  fromPartial(object) {
    ...
    message.objects =
      ((_e = object.objects) === null || _e === void 0
        ? void 0
        : _e.map((e) => SearchResult.fromPartial(e))) || [];
    message.rerank =
...
export const MetadataResult = {
  ...
  fromPartial(object) {
    ...
    message.vectors =
      ((_y = object.vectors) === null || _y === void 0 ? void 0 : _y.map((e) => Vectors.fromPartial(e))) ||
      [];
    return message;
  },
};
  ...
  fromPartial(object) {
    ...
    message.refProps =
      ((_b = object.refProps) === null || _b === void 0
        ? void 0
        : _b.map((e) => RefPropertiesResult.fromPartial(e))) || [];
  ...
  fromPartial(object) {
    ...
    message.properties =
      ((_a = object.properties) === null || _a === void 0
        ? void 0
        : _a.map((e) => PropertiesResult.fromPartial(e))) || [];
