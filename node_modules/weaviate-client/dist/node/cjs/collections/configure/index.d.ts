...
declare const configure: {
  generative: {
    ...
    >;
    palm: (
      config: import('../types/index.js').GenerativePaLMConfig
    ) => import('../types/index.js').ModuleConfig<
      'generative-palm',
      import('../types/index.js').GenerativePaLMConfig
    >;
  };
  reranker: {
    cohere: (
  ...
  vectorizer: {
    ...
    ref2VecCentroid: <N_5 extends string | undefined = undefined, I_5 extends string = 'hnsw'>(
      opts: import('./types/vectorizer.js').ConfigureNonTextVectorizerOptions<N_5, I_5, 'ref2vec-centroid'>
    ) => import('./types/vectorizer.js').VectorConfigCreate<never, N_5, I_5, 'ref2vec-centroid'>;
    text2VecAWS: <T, N_6 extends string | undefined = undefined, I_6 extends string = 'hnsw'>(
      opts: import('./types/vectorizer.js').ConfigureTextVectorizerOptions<T, N_6, I_6, 'text2vec-aws'>
      ...
      opts?:
        | (import('../types/index.js').Text2VecHuggingFaceConfig & {
            ...
            vectorIndexConfig?:
              | import('../types/index.js').ModuleConfig<
                  I_11,
                  import('./types/vectorIndex.js').VectorIndexConfigCreateType<I_11>
                >
              | undefined;
          })
        | undefined
    ...
    text2VecPalm: <T_9, N_15 extends string | undefined = undefined, I_15 extends string = 'hnsw'>(
      opts?:
        | (import('../types/index.js').Text2VecPalmConfig & {
            name?: N_15 | undefined;
  ...
  vectorIndex: {
    flat: (
      ...
      'flat',
      | import('./types/base.js').RecursivePartial<import('../types/index.js').VectorIndexConfigFlat>
      | undefined
    >;
    hnsw: (
      ...
      'hnsw',
      | import('./types/base.js').RecursivePartial<import('../types/index.js').VectorIndexConfigHNSW>
      | undefined
    >;
    dynamic: (
      ...
      'dynamic',
      | import('./types/base.js').RecursivePartial<import('../types/index.js').VectorIndexConfigDynamic>
      | undefined
    >;
    quantizer: {
      bq: (
