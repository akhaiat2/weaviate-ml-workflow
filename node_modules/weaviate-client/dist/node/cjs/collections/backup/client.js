      ...
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (args.waitForCompletion) {
          ...
          while (wait) {
            ...
            if (res.status === 'FAILED') {
              throw new errors_js_1.WeaviateBackupFailed(res.error ? res.error : '<unknown>', 'creation');
            }
      ...
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (args.waitForCompletion) {
          ...
          while (wait) {
            ...
            if (res.status === 'FAILED') {
              throw new errors_js_1.WeaviateBackupFailed(res.error ? res.error : '<unknown>', 'restoration');
            }
            yield new Promise((resolve) => setTimeout(resolve, 1000)); // eslint-disable-line no-await-in-loop
          }
        }
